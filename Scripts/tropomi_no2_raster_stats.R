####################################################################################################
#   Calculate raster stat maps.
#
#  	--- Last updated:  03.24.2022 BY Shawn P. Serbin <sserbin@bnl.gov>
####################################################################################################
...
list.of.packages <- c("raster","maps","mapdata","ggplot2", "lubridate", "spatial.tools","here")
...
#--------------------------------------------------------------------------------------------------#
#### Input geotiffs
local_geotiff_storage_dir <- file.path(here::here(),"/Data/TROPOMI/geotiff_grid_files")

#### Output
output_stats_raster_dir <- file.path(here::here(),"/Data/TROPOMI/geotiff_raster_stats")
