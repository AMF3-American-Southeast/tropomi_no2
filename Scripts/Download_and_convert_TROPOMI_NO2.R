...
#
#
#  	--- Last updated:  03.24.2023 BY Shawn P. Serbin <sserbin@bnl.gov>
####################################################################################################
...
#--------------------------------------------------------------------------------------------------#
### Function arguments
local_ascii_storage_dir <- file.path(here::here(),"/Data/TROPOMI/ascii_grid_files")
...
if (! file.exists(local_geotiff_storage_dir)) dir.create(file.path(local_geotiff_storage_dir),recursive=TRUE, 
                                                 showWarnings = FALSE)
local_figure_dir <- file.path(here::here(),"/Data/TROPOMI/quicklooks")
